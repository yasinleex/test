...
if [ ! -e ./.config ] ; then
	if [ "$PHONE_BOARD_VERSION" = "YL8150S_EVB" ] ; then	
		...
		echo "Select yongda pad board version is v1.0"
		make yongda_v1_0_defconfig
	...
	elif [ "$PHONE_BOARD_VERSION" = "FOURMODE_V1_0" ] ; then
		echo "Select fourmode board"
		make lc1860_fourmode_v1_0_defconfig
	elif [ "$PHONE_BOARD_VERSION" = "V90_V1_0" ] ; then
		echo "Select Datang V90 board"
		make V90_phone_v1_0_defconfig 
	else
		...
		M9206_V1_0, LX70A_V1_0,K706_V1_0,YONGDA_V1_0, FOURMODE_V1_0, LC1860_PHONE, SMARTMODULE_V1_0, V90_V1_0"
