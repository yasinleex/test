...
#define LED_DEF(NUM, COLOR) \
     { \
         .name= TO_STR(LED##NUM##_##COLOR),  \
         .gpio= LED##NUM##_##COLOR##_EN_PIN, \
...
static struct pwm_lookup leds_pwm_lookup[] = {
	PWM_LOOKUP("gpio-pwm", 0, NULL, "IR1"),
	PWM_LOOKUP("gpio-pwm", 1, NULL, "IR2"),
    PWM_LOOKUP("gpio-pwm", 2, NULL, "FM8010"),
};
...
#ifdef CONFIG_PWM_GPIO

static struct gpio_pwm_info gpio_info[]= {
    GPIO_PWM_INFO("IR1", IR_EN1_PIN, 1000*1000, 1000*500, 1),
    GPIO_PWM_INFO("IR2", IR_EN2_PIN, 1000*1000, 1000*500, 1),
    GPIO_PWM_INFO("FM8010", COMIP_GPIO_VIDEO_OUT, 1000*1000, 1000*500, 1),
};

static struct gpio_pwm_plat_data gpio_pwm_data = {
    .num_pwms    = ARRAY_SIZE(gpio_info),
	.info    = gpio_info,
};

static struct platform_device gpio_pwm = {
	.name	= "gpio-pwm",
	.id	= -1,
	.dev	= {
		.platform_data = &gpio_pwm_data,
	},
};
#endif 
#ifdef CONFIG_SWITCH_GPIO
static struct gpio_switch_platform_data gpio_switch={
    .name = "sim-detect",
    .gpio = SIM_DET_N_PIN,
    .active_level = GPIO_SWITCH_ACTIVE_LOW,
    ...
    .state_on = "connected",
    .state_off = "disconnect",
};
static struct platform_device sim_detect_switch = {
    .name = "switch-gpio",
    .id	= -1,
    .dev = {
        .platform_data = &gpio_switch,
	},
};
#endif 
...
static struct mfp_pin_cfg comip_mfp_cfg[] = {
	...
	{FM23_DDB2_MCLK_PIN, MFP_PIN_MODE_0},
#endif

       { DIG_MIC_EN_PIN,  MFP_PIN_MODE_GPIO},   //lvrongguo add @20160219 for dmic micbias
	/* LCD. */
	{LCD_RESET_PIN,			MFP_PIN_MODE_GPIO},
#if defined(CONFIG_SENSORS_INV_MPU6880)
	{INV6880_INT_PIN,		MFP_PIN_MODE_GPIO},
#endif
#if defined(CONFIG_HDMI_Sii902xA)
	{HDMI_PIN_INT, MFP_PIN_MODE_GPIO},
	{HDMI_PIN_HPD, MFP_PIN_MODE_GPIO},
	{HDMI_PIN_RST, MFP_PIN_MODE_GPIO},
	{HDMI_PIN_5V_EN, MFP_PIN_MODE_GPIO},
	{HDMI_PIN_1V2_EN, MFP_PIN_MODE_GPIO},
#endif
	...
	{OV4689_MCLK_PIN,		MFP_PIN_MODE_GPIO},
#endif
	...
	{HSIC_DEVICE_CONN_PIN,  MFP_PIN_MODE_GPIO},
	{HSIC_DETECT_PIN,  		MFP_PIN_MODE_GPIO},
#endif
	...
	{DBB2IR_CUT_CTL2_PIN, 	MFP_PIN_MODE_GPIO},
	{DBB2IR_CUT_CTL1_PIN, 	MFP_PIN_MODE_GPIO},

#if 1
	{MFP_PIN_GPIO(125), 	MFP_PIN_MODE_0},
	{MFP_PIN_GPIO(126), 	MFP_PIN_MODE_0},
	{MFP_PIN_GPIO(127), 	MFP_PIN_MODE_0},
	{MFP_PIN_GPIO(128), 	MFP_PIN_MODE_0},
	{MFP_PIN_GPIO(129), 	MFP_PIN_MODE_0},
	{MFP_PIN_GPIO(130), 	MFP_PIN_MODE_0},
	{MFP_PIN_GPIO(131), 	MFP_PIN_MODE_0},
	{MFP_PIN_GPIO(132), 	MFP_PIN_MODE_0},
	{MFP_PIN_GPIO(133), 	MFP_PIN_MODE_0},
	{MFP_PIN_GPIO(134), 	MFP_PIN_MODE_0},
	{MFP_PIN_GPIO(135), 	MFP_PIN_MODE_0},
	{MFP_PIN_GPIO(136), 	MFP_PIN_MODE_0},
	{MFP_PIN_GPIO(137), 	MFP_PIN_MODE_0},
	{MFP_PIN_GPIO(138), 	MFP_PIN_MODE_0},
	{MFP_PIN_GPIO(139), 	MFP_PIN_MODE_0},
	{MFP_PIN_GPIO(140), 	MFP_PIN_MODE_0},
	{MFP_PIN_GPIO(141), 	MFP_PIN_MODE_0},
	{MFP_PIN_GPIO(142), 	MFP_PIN_MODE_0},
	{MFP_PIN_GPIO(143), 	MFP_PIN_MODE_0},
	{MFP_PIN_GPIO(144), 	MFP_PIN_MODE_0},
	{MFP_PIN_GPIO(145), 	MFP_PIN_MODE_0},
	{MFP_PIN_GPIO(146), 	MFP_PIN_MODE_0},
	{MFP_PIN_GPIO(147), 	MFP_PIN_MODE_0},
	{MFP_PIN_GPIO(148), 	MFP_PIN_MODE_0},
#endif

    {IR_EN1_PIN,    MFP_PIN_MODE_GPIO},
    {IR_EN2_PIN,    MFP_PIN_MODE_GPIO},

    {LED1_RED_EN_PIN,    MFP_PIN_MODE_GPIO},
    {LED1_GREEN_EN_PIN,  MFP_PIN_MODE_GPIO},
    {LED2_RED_EN_PIN,    MFP_PIN_MODE_GPIO},
    {LED2_GREEN_EN_PIN,  MFP_PIN_MODE_GPIO},
    {LED3_RED_EN_PIN,    MFP_PIN_MODE_GPIO},
    {LED3_GREEN_EN_PIN,  MFP_PIN_MODE_GPIO},
    {LED4_RED_EN_PIN,    MFP_PIN_MODE_GPIO},
    {LED4_GREEN_EN_PIN,  MFP_PIN_MODE_GPIO},

    {COMIP_GPIO_VIDEO_OUT, MFP_PIN_MODE_GPIO},

    {HSIC_CLKOUT3_PIN, 	MFP_PIN_MODE_0},
    {USB_OTG_5V_EN_PIN,				MFP_PIN_MODE_GPIO},
    {USB_5V_CONN_MINIUSB_EN_PIN,	MFP_PIN_MODE_GPIO},
    {USB_5V_CONN_EXTPORT_EN_PIN,	MFP_PIN_MODE_GPIO},

	{SIM_DET_N_PIN, 	MFP_PIN_MODE_GPIO},

#ifdef CONFIG_TYPE_C_DET_PI5USB30216A
	{USB0_CC2BB_EN_PIN, 	MFP_PIN_MODE_GPIO},
    {USB0_CC2BB_INT_N_PIN,  MFP_PIN_MODE_GPIO},
#endif
...
static struct mfp_pull_cfg comip_mfp_pull_cfg[] = {
...
#if defined (CONFIG_USB_HSIC_USB3503)
	{HSIC_DETECT_PIN,  			MFP_PULL_UP},
#endif

	{ DIG_MIC_EN_PIN,  MFP_PULL_UP},	 //lvrongguo add @20160219 for dmic micbias
	...
	{MFP_PIN_GPIO(109), 	MFP_PULL_UP},
	{MFP_PIN_GPIO(108), 	MFP_PULL_UP},
	{MFP_PIN_GPIO(107), 	MFP_PULL_UP},
    ...
    {USB_OTG_5V_EN_PIN,				MFP_PULL_DOWN},
    {USB_5V_CONN_MINIUSB_EN_PIN,	MFP_PULL_DOWN},
    {USB_5V_CONN_EXTPORT_EN_PIN,	MFP_PULL_DOWN},
...
#if 0
	{MFP_PIN_GPIO(125), 	MFP_PULL_UP},
	{MFP_PIN_GPIO(126), 	MFP_PULL_UP},
	{MFP_PIN_GPIO(127), 	MFP_PULL_UP},
	{MFP_PIN_GPIO(128), 	MFP_PULL_UP},
	{MFP_PIN_GPIO(129), 	MFP_PULL_UP},
	{MFP_PIN_GPIO(130), 	MFP_PULL_UP},
	{MFP_PIN_GPIO(131), 	MFP_PULL_UP},
	{MFP_PIN_GPIO(132), 	MFP_PULL_UP},
	{MFP_PIN_GPIO(133), 	MFP_PULL_UP},
	{MFP_PIN_GPIO(134), 	MFP_PULL_UP},
	{MFP_PIN_GPIO(135), 	MFP_PULL_UP},
	{MFP_PIN_GPIO(136), 	MFP_PULL_UP},
	{MFP_PIN_GPIO(137), 	MFP_PULL_UP},
	{MFP_PIN_GPIO(138), 	MFP_PULL_UP},
	{MFP_PIN_GPIO(139), 	MFP_PULL_UP},
	{MFP_PIN_GPIO(140), 	MFP_PULL_UP},
	{MFP_PIN_GPIO(141), 	MFP_PULL_UP},
	{MFP_PIN_GPIO(142), 	MFP_PULL_UP},
	{MFP_PIN_GPIO(143), 	MFP_PULL_UP},
	{MFP_PIN_GPIO(144), 	MFP_PULL_UP},
	{MFP_PIN_GPIO(145), 	MFP_PULL_UP},
	{MFP_PIN_GPIO(146), 	MFP_PULL_UP},
	{MFP_PIN_GPIO(147), 	MFP_PULL_UP},
...
static struct mfp_gpio_cfg comip_init_mfp_lp_gpio_cfg[] = {
	{USB_OTG_5V_EN_PIN,				MFP_GPIO_OUTPUT},
	{USB_5V_CONN_MINIUSB_EN_PIN,	MFP_GPIO_OUTPUT},
	{USB_5V_CONN_EXTPORT_EN_PIN,	MFP_GPIO_OUTPUT},
...
#if defined (CONFIG_USB_HSIC_USB3503)
	{HSIC_DETECT_PIN,		MFP_GPIO_INPUT},
#endif
};
...
static struct pmic_power_module_map lc1160_power_module_map[] = {
	...
	{PMIC_ALDO11,	PMIC_POWER_GPS_CORE,		0,	1},
                                ...
                                struct kobj_attribute *attr, char *buf)
{
	...
	return sprintf(buf,
	               __stringify(EV_KEY) ":" __stringify(KEY_MENU) ":120:820:50:30"
	               ":" __stringify(EV_KEY) ":" __stringify(KEY_HOME) ":240:820:50:30"
	               ":" __stringify(EV_KEY) ":" __stringify(KEY_BACK) ":360:820:50:30"
	               "\n");
...
#if defined(CONFIG_HDMI_Sii902xA)
#define CI2CA true //hardware state: pull up
	#ifdef CI2CA
...
static void Sii902xA_reset(void)
{
	printk("Sii902xA_reset\n");
//	gpio_request(mfp_to_gpio(HDMI_RST_PIN), "HDMI_RST_PIN");
	gpio_direction_output(mfp_to_gpio(HDMI_PIN_RST), 0);
	msleep(200);
	gpio_direction_output(mfp_to_gpio(HDMI_PIN_RST), 1);
//	gpio_free(mfp_to_gpio(HDMI_RST_PIN));
}

struct Sii902xA_platform_data {
	void (*reset) (void);
	int gpio_pin_int;
	int gpio_pin_hpd;
	int gpio_pin_rst;
	int gpio_pin_hdmi5v_en;
	int gpio_pin_hdmi1v2_en;
};

static struct Sii902xA_platform_data Sii902xA_pdata = {
	.reset = Sii902xA_reset,
	.gpio_pin_int = mfp_to_gpio(HDMI_PIN_INT),
	.gpio_pin_hpd = mfp_to_gpio(HDMI_PIN_HPD),
	.gpio_pin_rst = mfp_to_gpio(HDMI_PIN_RST),
	.gpio_pin_hdmi5v_en = mfp_to_gpio(HDMI_PIN_5V_EN),
	.gpio_pin_hdmi1v2_en = mfp_to_gpio(HDMI_PIN_1V2_EN),
};
...
#if defined(CONFIG_USB_HSIC_USB3503)
static int hsic_power(int onoff)
{
	printk("hsic_power : %d\n", onoff);

    gpio_request(USB_OTG_5V_EN_PIN, "usb otg 5v en");
    gpio_request(USB_5V_CONN_EXTPORT_EN_PIN, "usb 5v extport en");

	if (onoff) {
		gpio_direction_output(USB_OTG_5V_EN_PIN, 1);
		msleep(10);
		gpio_direction_output(USB_5V_CONN_EXTPORT_EN_PIN, 1);
	} else {
		gpio_direction_output(USB_5V_CONN_EXTPORT_EN_PIN, 0);
		//gpio_direction_output(USB_OTG_5V_EN_PIN, 0);
	}

	gpio_free(USB_OTG_5V_EN_PIN);
	gpio_free(USB_5V_CONN_EXTPORT_EN_PIN);

	return 0;
}

struct usb3503_platform_data  usb3503_data= {
    .initial_mode = USB3503_MODE_HUB,
    .gpio_intn =  HSIC_INT_N_PIN,
    .gpio_connect =HSIC_DEVICE_CONN_PIN,
    .gpio_detect = HSIC_DETECT_PIN,
    .gpio_reset = HSIC_RESET_N_PIN,
    .detect_debounce_interval = 50,
    .clk_name = "clkout2_clk",
    .clk_parent_name = "pll1_mclk",
    .clk_rate = REF_CLK_PRI_26000000,
    .hsic_power = hsic_power,
};
#endif
...
struct fm23_platform_data  fm23_data= {
    ...
    .clk_name 	= "clkout0_clk",
    .clk_parent_name = "pll1_mclk",
    .clk_rate 	= FM23_MCLK_26M,
};
#endif

#ifdef CONFIG_TYPE_C_DET_PI5USB30216A
struct pericom_pdata pericom_pdata =  {
     .gpio_intb = mfp_to_gpio(USB0_CC2BB_INT_N_PIN),
     .gpio_mode = mfp_to_gpio(USB0_CC2BB_EN_PIN),
};
#endif
/* NFC. */
static struct i2c_board_info comip_i2c0_board_info[] = {
	...
	},
	{
		...
		.irq = gpio_to_irq(mfp_to_gpio(HDMI_PIN_INT)),//define the interrupt signal input pin
		.platform_data = &Sii902xA_pdata,
	},
#endif
};
...
static struct lm3642_platform_data  lm3642_data={
	.torch_pin = LM3642_TORCH_PIN_ENABLE,
	.strobe_pin =LM3642_STROBE_PIN_ENABLE ,
	.tx_pin = LM3642_TX_PIN_DISABLE,
};
...
static int ov8865_power(int onoff)
{
	...
	if (onoff) {
		...
		pmic_voltage_set(PMIC_POWER_CAMERA_AF_MOTOR, 0, PMIC_POWER_VOLTAGE_ENABLE);//[UNIPRO-tovey-20151114] add for camera 
		mdelay(10);
		...
		pmic_voltage_set(PMIC_POWER_CAMERA_ANALOG, 1, PMIC_POWER_VOLTAGE_DISABLE);
		//	pmic_voltage_set(PMIC_POWER_CAMERA_CORE, 1, PMIC_POWER_VOLTAGE_DISABLE);
		pmic_voltage_set(PMIC_POWER_CAMERA_AF_MOTOR, 0, PMIC_POWER_VOLTAGE_DISABLE);//[UNIPRO-tovey-20151114] add for camera 
...
//[UNIPRO-tovey-20151114] add for camera {
	.addr = 0x10,
	//.addr = 0x36,
//[UNIPRO-tovey-20151114] add for camera }
};
...
static int ov4689_mclk = mfp_to_gpio(OV4689_MCLK_PIN);
...
static int ov4689_power(int onoff)
{
	...
	if (onoff) {
		...
		pmic_voltage_set(PMIC_POWER_CAMERA_IO, 1, PMIC_POWER_VOLTAGE_ENABLE);
		mdelay(5);
		pmic_voltage_set(PMIC_POWER_CAMERA_CORE, 1, 1200);//pmic_voltage_set(PMIC_POWER_CAMERA_CORE, 1, 1500);
		mdelay(10);
		...
		mdelay(50);
		gpio_direction_output(ov4689_rst, 1);
		comip_mfp_config_ds(ov4689_mclk, MFP_DS_2MA);
	} else {
		pmic_voltage_set(PMIC_POWER_CAMERA_IO, 1, PMIC_POWER_VOLTAGE_DISABLE);
		pmic_voltage_set(PMIC_POWER_CAMERA_ANALOG, 1, PMIC_POWER_VOLTAGE_DISABLE);
		pmic_voltage_set(PMIC_POWER_CAMERA_CORE, 1, PMIC_POWER_VOLTAGE_DISABLE);
//		pmic_voltage_set(PMIC_POWER_CAMERA_AF_MOTOR, 1, PMIC_POWER_VOLTAGE_DISABLE);
...
static void __init comip_init_board(void)
{
	...
	pwm_add_table(leds_pwm_lookup, ARRAY_SIZE(leds_pwm_lookup));
