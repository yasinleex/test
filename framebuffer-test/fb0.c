...
{
    printf ("bytesPerPixel:%d (in that before).\n",color);
    ...
    printf ("bytesPerPixel:%d (in that after).\n",color);
...
while(1){
    printf ("Will draw 3 rectangles on the screen,\n"
            "they should be colored white (in that order).\n");

     drawRect (0, 0,
             vinfo.xres, vinfo.yres, 0x55555555);
    sleep (1);   
    
    printf ("Will draw 3 rectangles on the screen,\n"
            "they should be colored black (in that order).\n");
...
/*
     drawRect (0, 0,
             vinfo.xres, vinfo.yres, 0xffffffff);
    sleep (8);    
    
    
    printf ("Will draw 3 rectangles on the screen,\n"
            "they should be colored red (in that order).\n");
    ...
    sleep (8);     
      ...
      printf ("Will draw 3 rectangles on the screen,\n"
            "they should be colored green (in that order).\n");            
    drawRect (0, 0,
             vinfo.xres, vinfo.yres, 0xff00ff00);

    sleep (8);   
       printf ("Will draw 3 rectangles on the screen,\n"
            "they should be colored blue (in that order).\n");                  
...
while(1){
	...
	switch(choice){
		case 0:break;
		case 1:{printf("draw Black\n");   drawRect (0, 0, vinfo.xres, vinfo.yres, 0xff000000);}break;
		case 2:{printf("draw White\n");   drawRect (0, 0, vinfo.xres, vinfo.yres, 0xffffffff);}break;
		case 3:{printf("draw Red\n");     drawRect (0, 0, vinfo.xres, vinfo.yres, 0xffff0000);}break;
		case 4:{printf("draw Green\n");   drawRect (0, 0, vinfo.xres, vinfo.yres, 0xff00ff00);}break;
		case 5:{printf("draw Blue\n");    drawRect (0, 0, vinfo.xres, vinfo.yres, 0xff0000ff);}break;
	}
